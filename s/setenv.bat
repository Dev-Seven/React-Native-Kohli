...
set JAVA_HOME=%homepath%\.jabba\jdk\openjdk@1.11.0
...
set PATH=%MYSQL_HOME%\bin;%JAVA_HOME%\bin;%SONARQUBE_HOME%\bin;%ANDROID_HOME%\tools;%ANDROID_HOME%\build-tools\31.0.0;%PATH%
